local bufferline = require 'apple-colors.integrations.bufferline'
local cmp = require 'apple-colors.integrations.cmp'
local colorscheme = require 'apple-colors.colorscheme'
local config = require 'apple-colors.config'
local utils = require 'apple-colors.utils'
local theme = {}
...
function theme.colorscheme()
  if vim.version().minor < 8 then
    vim.notify(
      'Neovim 0.8+ is required for apple-colors colorscheme',
