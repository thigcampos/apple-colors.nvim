local bufferline = require("cupertino.integrations.bufferline")
local cmp = require("cupertino.integrations.cmp")
local colorscheme = require("cupertino.colorscheme")
local config = require("cupertino.config")
local utils = require("cupertino.utils")
local theme = {}
...
function theme.colorscheme()
	if vim.version().minor < 8 then
		vim.notify("Neovim 0.8+ is required for cupertino colorscheme", vim.log.levels.ERROR, { title = "Min Theme" })
		return
	end
